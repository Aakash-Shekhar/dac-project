  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setErrorMessage(res.data.message || "Failed to send reset link. Please try again.");
      }
    } catch (error) {
      const errMsg = error.response?.data?.message || "Failed to send reset link. Please try again later.";
