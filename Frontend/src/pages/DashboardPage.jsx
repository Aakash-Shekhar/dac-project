    ...
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col h-[450px]">
          <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">Income vs. Expense Overview (This Year)</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col h-[450px]">
          <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">Expenses by Category (Current Month)</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md col-span-1 lg:col-span-2 flex flex-col h-[450px]">
          <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">Income Trend (This Year)</h2>
